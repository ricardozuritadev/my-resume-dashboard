...
export const EXPERIENCE_DATA: Experience[] = [
  {
    ...
    positionIcon: EXPERIENCE.COMPANIES.CYC.POSITION_ICON,
  ...
  },
  {
    ...
    positionIcon: EXPERIENCE.COMPANIES.THE_BRIDGE.POSITION_ICON,
    responsibilities: EXPERIENCE.COMPANIES.THE_BRIDGE.RESPONSIBILITIES,
    appliedSkills: [
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.HTML,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.CSS,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.JAVASCRIPT,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.REACT,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.NODE,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.EXPRESS,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.MONGO_DB,
      EXPERIENCE.COMPANIES.THE_BRIDGE.APPLIED_SKILLS.POSTGRE_SQL
    ],
  ...
  },
  {
    ...
    positionIcon: EXPERIENCE.COMPANIES.CLEVERPY.POSITION_ICON,
    responsibilities: EXPERIENCE.COMPANIES.CLEVERPY.RESPONSIBILITIES,
    appliedSkills: [
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.JAVASCRIPT,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.TYPESCRIPT,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.REACT,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.OPEN_LAYERS,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.GIT,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.BEM,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.JIRA,
      EXPERIENCE.COMPANIES.CLEVERPY.APPLIED_SKILLS.AGILE
    ],
